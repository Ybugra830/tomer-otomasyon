...
export default function Header() {
    return (
        <header className="sticky top-0 z-50 bg-slate-900/90 backdrop-blur-md text-white border-b border-white/10 shadow-sm">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex flex-col md:flex-row items-center justify-between transition-all">
                <nav className="flex space-x-8 text-sm md:text-base font-medium mb-4 md:mb-0 opacity-80 hover:opacity-100 transition-opacity">
                    <a href="#" className="hover:text-emerald-400 transition-colors">Hakkımızda</a>
                </nav>
                <div className="flex flex-col items-center group cursor-pointer">
                    <div className="flex items-center justify-center space-x-4">
                        ...
                        <div className="flex flex-col items-start">
                            ...
                            <p className="text-xs text-emerald-400 mt-1.5 uppercase tracking-[0.2em] font-medium opacity-90">Language Center (TÖMER)</p>
                        </div>
                    </div>
                </div>
                <nav className="flex space-x-8 text-sm md:text-base font-medium mt-4 md:mb-0 opacity-80 hover:opacity-100 transition-opacity">
                    <a href="#" className="hover:text-emerald-400 transition-colors">İletişim</a>
                </nav>
            </div>
            <div className="h-0.5 w-full bg-gradient-to-r from-emerald-500 via-teal-400 to-emerald-500 opacity-80"></div>
        </header>
    );
}
